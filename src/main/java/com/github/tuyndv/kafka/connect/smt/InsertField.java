 ...
 */
package com.github.tuyndv.kafka.connect.smt;
...
public abstract class InsertField<R extends ConnectRecord<R>> implements Transformation<R> {
	...
	public static final String OVERVIEW_DOC = "Insert field(s) using attributes from the record metadata or a configured static value with datatype."
	...
	private interface ConfigName {
		...
		String STATIC_TYPE = "static.type";
	...
	public static final ConfigDef CONFIG_DEF = new ConfigDef()
			...
			.define(ConfigName.STATIC_TYPE, ConfigDef.Type.STRING, null, ConfigDef.Importance.MEDIUM,
					"Field name for static type field. ")
	...
	public void configure(Map<String, ?> props) {
		...
		staticType = config.getString(ConfigName.STATIC_TYPE);
		...
		if (staticField != null) {
			...
			case "int8":
				builder.field(staticField.name,
						staticField.optional ? Schema.OPTIONAL_INT8_SCHEMA : Schema.INT8_SCHEMA);
				break;
			case "int16":
				builder.field(staticField.name,
						staticField.optional ? Schema.OPTIONAL_INT16_SCHEMA : Schema.INT16_SCHEMA);
				break;
			case "int32":
				builder.field(staticField.name,
						staticField.optional ? Schema.OPTIONAL_INT32_SCHEMA : Schema.INT32_SCHEMA);
				break;
			case "int64":
				builder.field(staticField.name,
						staticField.optional ? Schema.OPTIONAL_INT64_SCHEMA : Schema.INT64_SCHEMA);
				break;
			case "float32":
				builder.field(staticField.name,
						staticField.optional ? Schema.OPTIONAL_FLOAT32_SCHEMA : Schema.FLOAT32_SCHEMA);
				break;
			case "float64":
				builder.field(staticField.name,
						staticField.optional ? Schema.OPTIONAL_FLOAT64_SCHEMA : Schema.FLOAT64_SCHEMA);
				break;
			case "boolean":
				builder.field(staticField.name,
						staticField.optional ? Schema.OPTIONAL_BOOLEAN_SCHEMA : Schema.BOOLEAN_SCHEMA);
				break;
			default:
				builder.field(staticField.name,
